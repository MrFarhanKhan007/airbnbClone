import { View, Text, Image, StyleSheet, Dimensions, Share, TouchableOpacity } from 'react-native'
...
const Page = () => {
    ...
    const listing: AirbnbListing = (listingsData as any[]).find((item) => item.id == id)
